...
function CopilotPage() {
  ...
  const recentRuns =
    (runsData as PaginatedResponse<JobRun> | undefined)?.data ?? [];
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Local-only project assistant powered by the agents and runs
        ...
        <div className="grid gap-4">
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div>
                {recentRuns.length} recent runs loaded for local analysis.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use the local eval framework before widening the prompt or tool
                surface.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 text-sm">
              ...
              <Button
                onClick={() =>
                  setPrompt("How should I evaluate a new agent locally?")
                }
                type="button"
                variant="outline"
              >
