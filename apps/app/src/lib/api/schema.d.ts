...
export type paths = {
    ...
    "/v1/agents": {
        ...
        /**
         * List agents
         * @description Returns a paginated list of agents in the current project.
         */
        get: operations["list-agents"];
        put?: never;
        /**
         * Create an agent
         * @description Creates a new agent and its hidden backing job in the current project.
         */
    ...
    "/v1/agents/{agentID}": {
        ...
        /**
         * Delete an agent
         * @description Deletes an agent and its hidden backing job.
         */
        ...
        /**
         * Update an agent
         * @description Updates mutable agent fields in the current project.
         */
    ...
    "/v1/agents/{agentID}/deploy": {
        ...
        /**
         * Deploy an agent
         * @description Creates a new local-stub deployment for an agent.
         */
        post: operations["deploy-agent"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/agents/{agentID}/run": {
        ...
        /**
         * Run an agent
         * @description Triggers a local stub run for the latest deployed agent version.
         */
        post: operations["run-agent"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/agents/{agentID}/runs": {
        ...
        /**
         * List agent runs
         * @description Returns runs associated with an agent's hidden backing job.
         */
        get: operations["list-agent-runs"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export type components = {
    schemas: {
        ...
        Agent: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://api.strait.dev/schemas/Agent.json
             */
            readonly $schema?: string;
            config?: unknown;
            /** Format: date-time */
        ...
        AgentDeployment: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://api.strait.dev/schemas/AgentDeployment.json
             */
            readonly $schema?: string;
            agent_id: string;
        ...
        CreateAgentRequest: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://api.strait.dev/schemas/CreateAgentRequest.json
             */
            readonly $schema?: string;
            config?: unknown;
            description?: string;
        ...
        RunAgentRequest: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://api.strait.dev/schemas/RunAgentRequest.json
             */
            readonly $schema?: string;
            payload?: unknown;
        };
        ...
        UpdateAgentRequest: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://api.strait.dev/schemas/UpdateAgentRequest.json
             */
            readonly $schema?: string;
            config?: unknown;
            description?: string;
    ...
    "list-agent-runs": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["JobRun"][] | null;
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "list-event-source-subscriptions": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EventSubscription"][] | null;
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    "list-notification-channels": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NotificationChannel"][] | null;
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    "list-notification-deliveries": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NotificationDelivery"][] | null;
                };
            };
            /** @description Unauthorized */
            401: {
