 ...
 * the self-host Docker image and the Deploy to Cloudflare flow.
 *
 ...
 * billing on without the CF project needing to set any new env var.
 * The self-host Dockerfile and the Deploy to Cloudflare button both
 * explicitly set `VITE_STRAIT_EDITION=community` at build time.
 *
