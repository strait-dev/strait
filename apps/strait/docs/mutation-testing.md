...
| `./internal/queue` | 518 | 259 | Broad queue surface; enqueue terminal error helper slice is clean with 4 killed mutants. Continue splitting by backpressure, retry, route selection, PgQue claim/dequeue/ready, and metrics helpers before a full run. |
