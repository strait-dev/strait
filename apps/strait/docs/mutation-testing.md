...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver, entitlement snapshot, project cost aggregation, plan-limit resolution, catalog resolver, PostHog client, Prometheus uptime source, and threshold warning slices are clean with 108 killed mutants. Split by enforcement, webhook, usage, and email subareas before a full run. |
