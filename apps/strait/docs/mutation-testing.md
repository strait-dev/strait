...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver slice is clean with 3 killed mutants. Split by entitlement, enforcement, webhook, usage, and email subareas before a full run. |
