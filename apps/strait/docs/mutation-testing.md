...
| `./internal/queue` | 530 | 247 | Broad queue surface; enqueue terminal error helper, backpressure, enqueue retry, and PgQue route selection slices are clean with 178 killed mutants. Continue splitting by PgQue claim/dequeue/ready and metrics helpers before a full run. |
