...
| `./internal/scheduler` | 1002 | 236 | Broad scheduler surface; quota resume advisory-lock, backpressure token cap, counter reconciler transaction, batch flusher, and contract expiry slices are clean with 105 killed mutants. Continue splitting by reapers, monitors, usage emailers, and reconciliation helpers before a full run. |
