...
| `./internal/scheduler` | 1001 | 237 | Broad scheduler surface; quota resume advisory-lock, backpressure token cap, counter reconciler transaction, and batch flusher slices are clean with 88 killed mutants. Continue splitting by reapers, monitors, usage emailers, and reconciliation helpers before a full run. |
