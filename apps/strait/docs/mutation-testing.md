...
| `./internal/queue` | 547 | 230 | Broad queue surface; enqueue terminal error helper, backpressure, enqueue retry, PgQue route selection, and PgQue claim helper slices are clean with 196 killed mutants. Continue splitting by PgQue dequeue/ready and metrics helpers before a full run. |
