...
| `./internal/scheduler` | 1009 | 229 | Broad scheduler surface; quota resume advisory-lock, backpressure token cap, counter reconciler transaction, batch flusher, contract expiry, and webhook message cleanup slices are clean with 114 killed mutants. Continue splitting by reapers, monitors, usage emailers, and reconciliation helpers before a full run. |
