...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver, entitlement snapshot, project cost aggregation, plan-limit resolution, catalog resolver, and PostHog client slices are clean with 52 killed mutants. Split by enforcement, webhook, usage, and email subareas before a full run. |
