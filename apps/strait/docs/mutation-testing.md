...
| `./internal/loadtest` | 293 | 640 | Broad load-test harness surface; runtime profile, queue bloat gate, queue benchmark report, and performance baseline report helper slices are clean with 245 killed mutants. Continue splitting by reporting, scenarios, and server helpers before a full run. |
