...
| `./internal/scheduler` | 998 | 240 | Broad scheduler surface; quota resume advisory-lock and backpressure token cap helper slices are clean with 25 killed mutants. Continue splitting by reapers, batch flusher, monitors, usage emailers, and reconciliation helpers before a full run. |
