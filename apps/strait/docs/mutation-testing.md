...
| `./internal/queue` | 528 | 249 | Broad queue surface; enqueue terminal error helper, backpressure, and enqueue retry slices are clean with 88 killed mutants. Continue splitting by route selection, PgQue claim/dequeue/ready, and metrics helpers before a full run. |
