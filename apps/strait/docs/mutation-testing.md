...
| `./internal/loadtest` | 282 | 651 | Broad load-test harness surface; runtime profile, queue bloat gate, and queue benchmark report helper slices are clean with 166 killed mutants. Continue splitting by reporting, scenarios, and server helpers before a full run. |
