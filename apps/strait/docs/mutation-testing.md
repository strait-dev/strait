...
| `./internal/loadtest` | 280 | 653 | Broad load-test harness surface; runtime profile and queue bloat gate helper slices are clean with 61 killed mutants. Continue splitting by reporting, scenarios, and server helpers before a full run. |
