...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver, entitlement snapshot, project cost aggregation, plan-limit resolution, catalog resolver, PostHog client, Prometheus uptime source, threshold warning, and add-on limit slices are clean with 160 killed mutants. Split by enforcement, webhook, usage, and email subareas before a full run. |
