...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver, entitlement snapshot, project cost aggregation, plan-limit resolution, catalog resolver, PostHog client, and Prometheus uptime source slices are clean with 66 killed mutants. Split by enforcement, webhook, usage, and email subareas before a full run. |
