...
| `./internal/workflow` | 1238 | 17 | Added raw condition, JSON scanner, object payload merge, step override filtering, expected-completion, simulator conditional, workflow run helper, topological helper, progression fallback, bootstrap fallback, root max-parallel, and cost-gate dry-run coverage; continue with callback progression, retry, and payload scanner clusters. |
