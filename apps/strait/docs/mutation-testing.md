...
| `./internal/scheduler` | 1000 | 238 | Broad scheduler surface; quota resume advisory-lock, backpressure token cap, and counter reconciler transaction helper slices are clean with 41 killed mutants. Continue splitting by reapers, batch flusher, monitors, usage emailers, and reconciliation helpers before a full run. |
