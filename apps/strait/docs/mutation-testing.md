...
| `./internal/billing` | 1060 | 453 | Large default-edition surface; retention resolver and entitlement snapshot slices are clean with 9 killed mutants. Split by enforcement, webhook, usage, and email subareas before a full run. |
