...
| `./internal/queue` | 626 | 151 | Broad queue surface; enqueue terminal error helper, backpressure, enqueue retry, PgQue route selection, PgQue claim helper, and PgQue dequeue slices are clean with 318 killed mutants. Continue splitting by PgQue ready and metrics helpers before a full run. |
