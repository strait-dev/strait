...
| `./internal/queue` | 525 | 252 | Broad queue surface; enqueue terminal error helper and backpressure slices are clean with 52 killed mutants. Continue splitting by retry, route selection, PgQue claim/dequeue/ready, and metrics helpers before a full run. |
