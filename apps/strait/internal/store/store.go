...
var (
	...
	ErrNotificationMessageStatusConflict = errors.New("notification message status conflict")
	...
	ErrNotifySuppressionEventNotFound    = errors.New("notify suppression event not found")
