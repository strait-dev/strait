...
var validTransitions = map[RunStatus][]RunStatus{
	...
	StatusExecuting:    {StatusCompleted, StatusFailed, StatusTimedOut, StatusCrashed, StatusCanceling, StatusCanceled, StatusWaiting, StatusQueued, StatusSystemFailed, StatusDeadLetter},
	StatusWaiting:      {StatusExecuting, StatusCompleted, StatusFailed, StatusCanceling, StatusCanceled, StatusTimedOut},
