...
var StrongNamespacePolicies = []StrongNamespacePolicy{
	{
		...
		MutationPaths:    []string{"handleCreateAPIKey", "handleRevokeAPIKey", "handleRotateAPIKey", "store.CreateRotatedAPIKey"},
	...
	},
	{
		...
		MutationPaths:    []string{"role create/update/delete", "member assign/remove", "resource policy create/delete", "tag policy create/delete", "system role seed"},
	...
	},
	{
		...
		MutationPaths:    []string{"subscription create/update/delete", "plan/status/payment/add-on changes", "spending limit changes"},
	...
	},
	{
		...
		MutationPaths:    []string{"handleCreateJob", "handleUpdateJob", "handleDeleteJob", "job state mutations that change dispatch config"},
	...
	},
	{
		...
		MutationPaths:    []string{"handleCreateJobDependency", "handleDeleteJobDependency", "store.CreateJobDependency", "store.DeleteJobDependency"},
