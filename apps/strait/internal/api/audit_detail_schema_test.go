...
var handlerActionPayloads = map[string]map[string]any{
	...
	domain.AuditActionNotifySubscriberUpserted:        {"subscriber_id": "sub-1"},
	domain.AuditActionNotifySubscriberUpdated:         {"subscriber_id": "sub-1"},
	domain.AuditActionNotifySubscriberDeleted:         {"subscriber_id": "sub-1", "purge": false},
	domain.AuditActionNotifyTopicCreated:              {"topic_id": "tpc-1", "topic_key": "alerts", "name": "Alerts"},
	domain.AuditActionNotifyTopicSubscriberRemoved:    {"topic_id": "tpc-1", "subscriber_id": "sub-1"},
	domain.AuditActionNotificationTemplateCreated:     {"template_id": "tmpl-1", "template_key": "welcome", "name": "Welcome"},
	domain.AuditActionNotificationTemplateUpdated:     {"template_id": "tmpl-2", "template_key": "welcome", "version": 2},
	domain.AuditActionNotificationCategoryCreated:     {"category_id": "cat-1", "category_key": "alerts", "name": "Alerts"},
	domain.AuditActionNotifyPolicyOverrideCreated:     {"policy_id": "pol-1", "scope_type": "project", "scope_key": "proj-1"},
	domain.AuditActionNotifyPolicyOverrideUpdated:     {"policy_id": "pol-1"},
	domain.AuditActionNotifyPolicyOverrideDeleted:     {"policy_id": "pol-1"},
	domain.AuditActionNotificationProviderUpdated:     {"provider_id": "prov-1", "channel": "email", "provider": "ses", "name": "SES"},
	domain.AuditActionNotificationProviderDeleted:     {"provider_id": "prov-1"},
	domain.AuditActionNotifySubscriberTokenCreated:    {"subscriber_id": "sub-1", "tenant_id": "tenant-1", "expires_in_seconds": int64(3600)},
	domain.AuditActionNotifyUnsuppressCreated:         {"subscriber_id": "sub-1", "channel": "email", "scope": "global", "reason": "manual", "force": false},
	...
	domain.AuditActionCodeDeploymentCreated:           {"job_id": "job-1", "runtime": "python"},
	domain.AuditActionCodeDeploymentConfirmed:         {"job_id": "job-1", "runtime": "python"},
	domain.AuditActionCodeDeploymentRolledBack:        {"job_id": "job-1", "runtime": "python"},
