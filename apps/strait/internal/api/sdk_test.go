...
func TestHandleListRuns_Success(t *testing.T) {
	...
	ms := &mockAPIStore{
		listRunsByProjectFn: func(_ context.Context, projectID string, status *domain.RunStatus, metadataKey, metadataValue, triggeredBy, batchID *string, payloadContains json.RawMessage, _ *domain.ExecutionMode, limit int, cursor *time.Time) ([]domain.JobRun, error) {
