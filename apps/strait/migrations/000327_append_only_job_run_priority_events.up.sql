CREATE TABLE IF NOT EXISTS job_run_priority_events (
...
CREATE INDEX IF NOT EXISTS idx_job_run_priority_events_latest
    ON job_run_priority_events(run_id, id DESC);
