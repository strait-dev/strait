...
-- one-shot repair: once 000308 installs the partial unique index, the
-- store and handler refuse to let duplicates recur.
--
-- The CREATE UNIQUE INDEX CONCURRENTLY half is split into 000308 because
...
-- index ships non-transactionally in 000308.
