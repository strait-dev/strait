...
func scenarioManagedFast10s(ctx *testCtx, iter int) error {
	return runManagedJob(ctx, iter, "managed-fast-10s", "ghcr.io/strait-dev/strait-loadtest:loadtest-python", map[string]string{
...
func scenarioManagedSlow30s(ctx *testCtx, iter int) error {
	return runManagedJob(ctx, iter, "managed-slow-30s", "ghcr.io/strait-dev/strait-loadtest:loadtest-python", map[string]string{
...
func scenarioManagedSlow60s(ctx *testCtx, iter int) error {
	return runManagedJob(ctx, iter, "managed-slow-60s", "ghcr.io/strait-dev/strait-loadtest:loadtest-python", map[string]string{
		"SCRIPT_NAME":   "slow_cpu_work.py",
		"WORK_DURATION": "60",
...
func scenarioManagedErrorExit1(ctx *testCtx, iter int) error {
	jobID, err := createManagedJob(ctx, iter, "managed-err1", "ghcr.io/strait-dev/strait-loadtest:loadtest-errors", 1, 60)
	if err != nil {
		return err
	}
...
func scenarioManagedErrorTimeout(ctx *testCtx, iter int) error {
	...
	jobID, err := createManagedJob(ctx, iter, "managed-timeout", "ghcr.io/strait-dev/strait-loadtest:loadtest-errors", 1, 15)
	if err != nil {
		return err
	}
	defer deleteJob(ctx, jobID)
...
func scenarioManagedCheckpointRecovery(ctx *testCtx, iter int) error {
	...
	jobID, err := createManagedJob(ctx, iter, "managed-cp", "ghcr.io/strait-dev/strait-loadtest:loadtest-errors", 3, 60)
	if err != nil {
		return err
	}
	defer deleteJob(ctx, jobID)
...
func scenarioConcurrentManagedJobs(ctx *testCtx, iter int) error {
	...
	jobID, err := createManagedJob(ctx, iter, "conc-managed", "ghcr.io/strait-dev/strait-loadtest:loadtest-errors", 1, 30)
	if err != nil {
		return err
	}
	defer deleteJob(ctx, jobID)
...
func scenarioMixedExecutionModes(ctx *testCtx, iter int) error {
	...
	managedJobID, err := createManagedJob(ctx, iter, "mix-managed", "ghcr.io/strait-dev/strait-loadtest:loadtest-errors", 1, 30)
	if err != nil {
		return err
	}
