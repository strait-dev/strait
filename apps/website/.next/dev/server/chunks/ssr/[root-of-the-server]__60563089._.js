...
const AudienceSection = async ()=>{
    ...
    const audienceData = data.website.home.audience;
    const sectionTitle = audienceData?.section?.title;
    const sectionDescription = audienceData?.section?.description;
    const audiences = audienceData?.items?.items ?? [];
    const hasRequiredContent = sectionTitle && audiences.length > 0;
...
const CTA = async ()=>{
    ...
    const subtext = ctaData?.subtext;
    const hasRequiredContent = title && description && buttonText && buttonHref && subtext;
    if (!hasRequiredContent) {
        return null;
    }
...
const HowItWorks = async ()=>{
    ...
    const howItWorksData = data.website.home.how_it_works;
    const sectionTitle = howItWorksData?.section?.title;
    const sectionDescription = howItWorksData?.section?.description;
    const ctaText = howItWorksData?.ctaText;
    const ctaHref = howItWorksData?.ctaHref;
    const steps = howItWorksData?.steps?.items ?? [];
    const hasRequiredContent = sectionTitle && ctaText && ctaHref && steps.length > 0;
    if (!hasRequiredContent) {
        return null;
    }
...
const TestimonialsSection = async ()=>{
    ...
    const testimonialData = data.website.home.testimonials;
    const sectionTitle = testimonialData?.section?.title;
    const sectionDescription = testimonialData?.section?.description;
    const testimonials = testimonialData?.items?.items ?? [];
    if (!(sectionTitle && sectionDescription) || testimonials.length === 0) {
        return null;
    }
...
"[project]/apps/website/src/app/(landing)/home/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$16$2e$1$2e$6$2b$6d2d1b167ad600d7$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$16$2e$1$2e$6$2b$6d2d1b167ad600d7$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$16$2e$1$2e$6$2b$6d2d1b167ad600d7$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$website$2f$src$2f$lib$2f$structured$2d$data$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JsonLd"], {
                ...
                fileName: "[project]/apps/website/src/app/(landing)/home/page.tsx",
                lineNumber: 69,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$16$2e$1$2e$6$2b$6d2d1b167ad600d7$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$website$2f$src$2f$lib$2f$structured$2d$data$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JsonLd"], {
...
"[project]/apps/website/src/app/(landing)/home/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/apps/website/src/app/(landing)/home/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__60563089._.js.map