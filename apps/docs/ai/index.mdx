...
<CardGroup cols={2}>
  ...
  <Card title="Local-First Runtime" icon="terminal" href="/docs/guides/local-agent-development">
    Develop agents locally through `apps/agents` and `@strait/agents-sdk` before deploying to Cloudflare.
  </Card>
...
- [`@strait/agents-sdk`](/docs/sdks/agents)
