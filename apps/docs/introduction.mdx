...
```text
                    ...
                    │  - Review ─> Review queue on exhaust│
                    └──────────┬───────────────────────┘
                               │ Webhook / PubSub
                               v
                    ┌──────────────────────────────────┐
...
<Steps>
  <Step title="Zero External Dependencies">
    No RabbitMQ. No SQS. No Kafka. PostgreSQL handles queuing—parallel workers without operational overhead. Single binary includes everything—no runtime dependencies to install.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Deployment" icon="cloud" href="/guides/deployment">
    Docker deployment, Kubernetes configuration, horizontal scaling strategies, and production readiness checklist.
  </Card>
