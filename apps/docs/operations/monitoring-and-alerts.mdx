...
| `strait_queue_outbox_quarantined_total` | Counter | Outbox rows terminalized into quarantine after non-retryable promotion failures |
...
- Outbox quarantine events and growth
...
- Outbox quarantined rows stay at zero outside planned incidents
