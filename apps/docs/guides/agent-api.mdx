...
It is intentionally separate from the runtime callback API used by executing agents. Runtime code should use `@strait/agents`, not these endpoints.

## Control Plane Surfaces

Today, agent lifecycle management is split across:

- dashboard
  - create, deploy, run, and inspect agents visually
- management API
  - automate agent lifecycle from your own tooling
- CLI
...
The runtime package `@strait/agents` is intentionally not part of this control-plane surface. It belongs inside an executing run.
