...
Use the included load testing framework against your own Postgres + Redis:

```bash
cd apps/strait

# Start Strait against a local Postgres + Redis
...
# Run the quick validation in a separate terminal
