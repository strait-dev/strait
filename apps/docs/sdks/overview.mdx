...
|---|---|---|---|---|---|
| **API operations** | `client.jobs.list()` | `client.jobs.list()` | `jobs.List(ctx)` | `jobs.list` | `jobs.list().await` |
...
+-------------------------------------------+
|  Composition Helpers                      |  retry, wait, paginate
+-------------------------------------------+
|  Domain Operations                        |  jobs, runs, workflows, ...
+-------------------------------------------+
