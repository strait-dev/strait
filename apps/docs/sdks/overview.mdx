...
All five SDKs implement the same capabilities:<sup>1</sup>
...
+-------------------------------------------+
|  Domain Operations (19 services)          |  jobs, runs, workflows, ...<sup>1</sup>
+-------------------------------------------+
...
<small><sup>1</sup> Service counts reflect the Go SDK. Other languages may organize operations into more or fewer services.</small>
