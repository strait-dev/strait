...
<Info>
Managed agent execution uses a separate package, [`@strait/agents-sdk`](/docs/sdks/agents). Use `@strait/ts` for control-plane and management API calls, and use `@strait/agents-sdk` inside running agents.
</Info>
