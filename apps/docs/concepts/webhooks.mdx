...
- `X-Strait-Replay-Key`: stable across every retry of the same delivery (derived deterministically from the delivery id). Use this header to dedup replays in your subscriber without tracking per-attempt state.
