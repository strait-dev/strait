...
The Go SDK (`github.com/strait-dev/strait-go`) uses the functional options pattern and provides full API coverage across 5 packages.
...
```go
import "github.com/strait-dev/strait-go/composition"
...
```go
import "github.com/strait-dev/strait-go/fsm"
...
|---|---|---|
| `strait` | `github.com/strait-dev/strait-go` | Client, config, errors, HTTP, middleware |
| `authoring` | `github.com/strait-dev/strait-go/authoring` | DefineJob, DefineWorkflow, steps, DAG validation |
| `composition` | `github.com/strait-dev/strait-go/composition` | Result, retry, wait, paginate, deployments |
| `fsm` | `github.com/strait-dev/strait-go/fsm` | Run, workflow, step state machines |
| `operations` | `github.com/strait-dev/strait-go/operations` | Domain services for all API endpoints |
