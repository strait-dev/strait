...
Approval steps automatically create a parallel [Event Trigger](/docs/concepts/event-triggers) when the workflow engine starts them. This means approvals can be resolved via either:
