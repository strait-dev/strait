...
<Tabs items={["Jobs","Runs","Workflows","Event Triggers","Environments"]}>
  <Tab value="Jobs">
...
<Cards>
  ...
  <Card title="Cost Budgets" href="/docs/concepts/cost-budgets">
...
<Cards>
  ...
  <Card title="Database Schema" href="/docs/development/database-schema">
...
- Learn about the **[queue mechanics](/docs/getting-started/architecture#queue-mechanics)** and how `SKIP LOCKED` works
- Understand the **[workflow engine](/docs/getting-started/architecture#workflow-engine)** and DAG execution
...
Or jump straight into the **[Quick Start Guide](/docs/getting-started/quickstart)** and run your first job in 5 minutes.
