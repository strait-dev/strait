...
<Callout type="info">
**Use the CLI** for most operations. It handles authentication, pagination, and output formatting automatically. See [CLI Reference](/docs/cli) for all commands.
</Callout>
...
<Cards>
  <Card title="Architecture Deep Dive" href="/docs/architecture">
    Learn about queue mechanics, the 13-state FSM, workflow engine, and why we chose our technology stack.
  </Card>
  <Card title="Concepts" href="/docs/concepts/jobs">
...
<Cards>
  ...
  <Card title="API Documentation" href="/docs/api-reference/overview">
