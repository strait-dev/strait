...
- Providers:
  ...
  - Internal provider callback endpoints (for ESP webhooks) are not part of the public OpenAPI surface.
    - Resend callback path: `POST /v1/notify/providers/{projectID}/{providerID}/callbacks/resend`
