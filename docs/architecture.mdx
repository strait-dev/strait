...
These controls are useful for branch-local retries after transient failures and for deterministic replay during incident mitigation.

## Data Model

The system uses PostgreSQL with the following primary tables (63 migrations):
