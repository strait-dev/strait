---
title: "Jobs"
description: "The fundamental unit of work in the orchestrator."
---
...
Jobs can be linked to an `environment_id`. This allows the orchestrator to apply environment-specific overrides, such as changing the `endpoint_url` when running in a "Staging" vs "Production" environment.
