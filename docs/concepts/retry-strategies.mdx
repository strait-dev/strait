...
description: "How the strait handles execution failures."
---

When a job execution fails (non-2xx response or timeout), the strait uses a retry strategy to determine when to attempt the execution again.
