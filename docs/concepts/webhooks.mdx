...
Webhooks allow your external services to be notified automatically when a [Job Run](/docs/concepts/runs) reaches a terminal state (e.g., `completed`, `failed`, `timed_out`).
