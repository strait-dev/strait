---
title: "Contributing"
description: "Guidelines for contributing to the strait project."
---

We welcome contributions to the strait! This document provides instructions on how to set up your development environment and the standards we follow.

## Getting Started

### Prerequisites

To build and run the strait locally, you need:
...
- `cmd/strait/`: Entry point for the CLI and server. Contains command definitions.
