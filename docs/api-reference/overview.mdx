...
## DAG and Dependency Diagnostics Endpoints

- `POST /v1/workflows/{workflowID}/plan`: Returns a topological plan preview for the current workflow version (supports step overrides).
- `GET /v1/runs/{runID}/dependency-status`: Returns dependency details and whether a waiting run is currently unblocked.
