---
title: "Security"
description: "Security features and protections implemented in the orchestrator."
---

The orchestrator includes several built-in security measures to protect the infrastructure and ensure the integrity of job executions.
...
The orchestrator implements rate limiting at two levels using the `httprate` middleware.
...
<Note>
  Security is a shared responsibility. While the orchestrator provides these protections, ensure your job endpoints also implement proper authentication and input validation.
</Note>
