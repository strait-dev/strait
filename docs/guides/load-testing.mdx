...
| --- | --- | --- |
| Queue throughput | Queue depth growing, dequeue rate flat | Increase `DB_MAX_CONNS`, optimize dequeue query |
...
| Database connections | `wait_count` increasing | Increase `DB_MAX_CONNS`, add connection pooler |
