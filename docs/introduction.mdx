...
<CardGroup cols={2}>
  <Card title="SDK Reference" icon="code" href="/docs/sdks/overview">
    Official SDKs for TypeScript, Python, and Go with full feature parity. Authoring DSL, composition helpers, and typed errors.
  </Card>
