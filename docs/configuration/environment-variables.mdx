...
| `DB_MAX_CONN_LIFETIME` | Duration | `1h` | Maximum amount of time a connection may be reused. |
| `DB_MAX_CONN_IDLE_TIME` | Duration | `30m` | Maximum amount of time a connection may be idle. |
