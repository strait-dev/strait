...
| Variable | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `CDC_BATCH_SIZE` | Integer | `100` | Number of change events to process in a single batch. |
| `CDC_WAIT_TIME_MS` | Integer | `1000` | Wait time in milliseconds for CDC long polling. |
