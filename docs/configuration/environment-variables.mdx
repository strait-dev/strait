...
description: "Complete reference of environment variables used to configure the strait."
---

This page documents all environment variables available for configuring the strait.
