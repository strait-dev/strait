...
The **Python**, **Go**, and **MCP** SDKs have moved to dedicated repositories. The TypeScript, Ruby, and Rust SDKs remain in this monorepo.

## Repositories

| SDK | Repository | Install |
|---|---|---|
| **TypeScript** | [packages/typescript-sdk](https://github.com/strait-dev/strait/tree/master/packages/typescript-sdk) (monorepo) | `npm install @strait/ts` |
...
| **Ruby** | [packages/ruby-sdk](https://github.com/strait-dev/strait/tree/master/packages/ruby-sdk) (monorepo) | `gem install strait` |
| **Rust** | [packages/rust-sdk](https://github.com/strait-dev/strait/tree/master/packages/rust-sdk) (monorepo) | `cargo add strait` |
