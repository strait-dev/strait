...
impl WebhooksService {
    ...
    pub async fn list_subscriptions(
        ...
        self.client
            .do_request("GET", "/v1/webhooks/subscriptions", query, None, None)
            .await
    }
    ...
    pub async fn create_subscription(
        ...
        self.client
            .do_request("POST", "/v1/webhooks/subscriptions", None, None, Some(body))
            .await
    }
    ...
    pub async fn list_deliveries(
        ...
        self.client
            .do_request("GET", "/v1/webhooks/deliveries", query, None, None)
            .await
    }
