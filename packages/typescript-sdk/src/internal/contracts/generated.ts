...
export const generatedOperations = [
  ...
  {
    id: "postSdkV1RunsByRunIDAnnotate",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/annotate",
    summary: "Attach annotations",
  },
  {
    id: "postSdkV1RunsByRunIDCheckpoint",
    tag: "SDK",
    method: "POST",
  ...
  {
    id: "postSdkV1RunsByRunIDComplete",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/complete",
    summary: "Mark run completed",
  },
  {
    id: "postSdkV1RunsByRunIDContinue",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/continue",
    summary: "Create a continuation run",
  },
  {
    id: "postSdkV1RunsByRunIDFail",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/fail",
    summary: "Mark run failed",
  },
  {
    id: "postSdkV1RunsByRunIDHeartbeat",
    tag: "SDK",
    method: "POST",
  ...
  {
    id: "postSdkV1RunsByRunIDOutput",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/output",
    summary: "Upsert structured output",
  },
  {
    id: "postSdkV1RunsByRunIDProgress",
    tag: "SDK",
    method: "POST",
  ...
  {
    id: "postSdkV1RunsByRunIDSpawn",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/spawn",
    summary: "Spawn a child job run",
  },
  {
    id: "postSdkV1RunsByRunIDToolCall",
    tag: "SDK",
    method: "POST",
  ...
  {
    id: "postSdkV1RunsByRunIDUsage",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/usage",
    summary: "Report AI model usage",
  },
  {
    id: "postSdkV1RunsByRunIDWaitForEvent",
    tag: "SDK",
    method: "POST",
    path: "/sdk/v1/runs/{runID}/wait-for-event",
    summary: "Pause a run to wait for an external event",
  },
  {
    id: "getV1AnalyticsPerformance",
    tag: "Analytics",
    method: "GET",
  ...
  {
    id: "getV1BatchOperationsByBatchID",
    tag: "BatchOperations",
    method: "GET",
  ...
  {
    id: "deleteV1EnvironmentsByEnvID",
    tag: "Environments",
    method: "DELETE",
  ...
  {
    id: "getV1EnvironmentsByEnvIDVariables",
    tag: "Environments",
    method: "GET",
  ...
  {
    id: "deleteV1EventSourcesBySourceID",
    tag: "EventSources",
    method: "DELETE",
  ...
  {
    id: "getV1EventSourcesBySourceID",
    tag: "EventSources",
    method: "GET",
    path: "/v1/event-sources/{sourceID}",
  ...
  {
    id: "patchV1EventSourcesBySourceID",
    tag: "EventSources",
    method: "PATCH",
    path: "/v1/event-sources/{sourceID}",
  ...
  {
    id: "postV1EventSourcesBySourceIDSubscribe",
    tag: "EventSources",
    method: "POST",
  ...
  {
    id: "getV1EventSourcesBySourceIDSubscriptions",
    tag: "EventSources",
    method: "GET",
  ...
  {
    id: "deleteV1EventSourcesBySourceIDSubscriptionsBySubID",
    tag: "EventSources",
    method: "DELETE",
  ...
  {
    id: "deleteV1EventsByEventKey",
    tag: "EventTriggers",
    method: "DELETE",
    path: "/v1/events/{eventKey}",
    summary: "Cancel a waiting event trigger",
  },
  {
    id: "getV1EventsByEventKey",
    tag: "EventTriggers",
    method: "GET",
    path: "/v1/events/{eventKey}",
    summary: "Get event trigger by key",
  },
  {
    id: "postV1EventsByEventKeySend",
    tag: "EventTriggers",
    method: "POST",
  ...
  {
    id: "getV1EventsByEventKeyStream",
    tag: "EventTriggers",
    method: "GET",
    path: "/v1/events/{eventKey}/stream",
    summary: "Stream event trigger status updates via SSE",
  },
  {
    id: "postV1EventsDispatch",
    tag: "EventSources",
    method: "POST",
  ...
  {
    id: "postV1EventsPrefixByPrefixSend",
    tag: "EventTriggers",
    method: "POST",
    path: "/v1/events/prefix/{prefix}/send",
    summary: "Send an event to all waiting triggers matching a prefix",
  },
  {
    id: "postV1EventsPurge",
    tag: "EventTriggers",
    method: "POST",
    path: "/v1/events/purge",
    summary: "Purge terminal event triggers",
  },
  {
    id: "getV1EventsStats",
    tag: "EventTriggers",
  ...
  {
    id: "getV1JobGroupsByGroupIDJobs",
    tag: "JobGroups",
    method: "GET",
  ...
  {
    id: "postV1JobGroupsByGroupIDPauseAll",
    tag: "JobGroups",
    method: "POST",
  ...
  {
    id: "postV1JobGroupsByGroupIDResumeAll",
    tag: "JobGroups",
    method: "POST",
  ...
  {
    id: "getV1JobGroupsByGroupIDStats",
    tag: "JobGroups",
    method: "GET",
    path: "/v1/job-groups/{groupID}/stats",
    summary: "Get aggregate run stats for a job group",
  },
  {
    id: "getV1Jobs",
    tag: "Jobs",
  ...
  {
    id: "getV1JobsByJobIDDependencies",
    tag: "Jobs",
    method: "GET",
  ...
  {
    id: "postV1JobsByJobIDDependencies",
    tag: "Jobs",
    method: "POST",
    path: "/v1/jobs/{jobID}/dependencies",
  ...
  {
    id: "deleteV1JobsByJobIDDependenciesByDepID",
    tag: "Jobs",
    method: "DELETE",
  ...
  {
    id: "getV1JobsByJobIDHealth",
    tag: "Jobs",
    method: "GET",
    path: "/v1/jobs/{jobID}/health",
    summary: "Get job health score",
  },
  {
    id: "postV1JobsByJobIDTrigger",
    tag: "Jobs",
    method: "POST",
  ...
  {
    id: "postV1JobsByJobIDTriggerBulk",
    tag: "Jobs",
    method: "POST",
    path: "/v1/jobs/{jobID}/trigger/bulk",
    summary: "Trigger multiple runs",
  },
  {
    id: "getV1JobsByJobIDVersions",
    tag: "Jobs",
    method: "GET",
  ...
  {
    id: "getV1JobsByJobIDVersionsByVersionID",
    tag: "Jobs",
    method: "GET",
    path: "/v1/jobs/{jobID}/versions/{versionID}",
    summary: "Get job version by version ID",
  },
  {
    id: "postV1JobsBatch",
    tag: "Jobs",
  ...
  {
    id: "postV1ResourcePolicies",
    tag: "RBAC",
    method: "POST",
    path: "/v1/resource-policies",
    summary: "Create resource policy",
  },
  {
    id: "deleteV1ResourcePoliciesByPolicyID",
    tag: "RBAC",
    method: "DELETE",
  ...
  {
    id: "getV1RunsByRunIDCheckpoints",
    tag: "Runs",
    method: "GET",
  ...
  {
    id: "postV1RunsByRunIDDebug",
    tag: "Runs",
    method: "POST",
    path: "/v1/runs/{runID}/debug",
    summary: "Enable/disable debug mode",
  },
  {
    id: "getV1RunsByRunIDDebugBundle",
    tag: "Runs",
    method: "GET",
  ...
  {
    id: "getV1RunsByRunIDDependencyStatus",
    tag: "Runs",
    method: "GET",
    path: "/v1/runs/{runID}/dependency-status",
    summary: "Get dependency status for a run",
  },
  {
    id: "postV1RunsByRunIDDlqReplay",
    tag: "Runs",
    method: "POST",
    path: "/v1/runs/{runID}/dlq-replay",
    summary: "Replay a dead-lettered run",
  },
  {
    id: "getV1RunsByRunIDEvents",
    tag: "Runs",
    method: "GET",
  ...
  {
    id: "deleteV1RunsByRunIDIdempotencyKey",
    tag: "Runs",
    method: "DELETE",
    path: "/v1/runs/{runID}/idempotency-key",
    summary: "Reset idempotency key for a run",
  },
  {
    id: "getV1RunsByRunIDLineage",
    tag: "Runs",
    method: "GET",
    path: "/v1/runs/{runID}/lineage",
    summary: "List run continuation lineage",
  },
  {
    id: "getV1RunsByRunIDOutputs",
    tag: "Runs",
    method: "GET",
    path: "/v1/runs/{runID}/outputs",
    summary: "List run structured outputs",
  },
  {
    id: "postV1RunsByRunIDReplay",
    tag: "Runs",
    method: "POST",
  ...
  {
    id: "postV1RunsByRunIDReschedule",
    tag: "Runs",
    method: "POST",
  ...
  {
    id: "getV1RunsByRunIDUsage",
    tag: "Runs",
    method: "GET",
    path: "/v1/runs/{runID}/usage",
    summary: "List run AI model usage",
  },
  {
    id: "postV1RunsBulkCancel",
    tag: "Runs",
    method: "POST",
  ...
  {
    id: "postV1RunsBulkCancelAll",
    tag: "Runs",
    method: "POST",
    path: "/v1/runs/bulk-cancel-all",
    summary: "Cancel all runs matching filters",
  },
  {
    id: "postV1RunsBulkDlqReplay",
    tag: "Runs",
    method: "POST",
    path: "/v1/runs/bulk-dlq-replay",
    summary: "Bulk replay dead-lettered runs",
  },
  {
    id: "postV1RunsBulkReplay",
    tag: "Runs",
    method: "POST",
    path: "/v1/runs/bulk-replay",
    summary: "Replay multiple runs by ID",
  },
  {
    id: "getV1RunsDlq",
    tag: "Runs",
  ...
  {
    id: "postV1TagPolicies",
    tag: "RBAC",
    method: "POST",
    path: "/v1/tag-policies",
    summary: "Create tag policy",
  },
  {
    id: "deleteV1TagPoliciesByPolicyID",
    tag: "RBAC",
    method: "DELETE",
    path: "/v1/tag-policies/{policyID}",
    summary: "Delete tag policy",
  },
  {
    id: "getV1WebhookDeliveries",
    tag: "Other",
    method: "GET",
  ...
  {
    id: "postV1WebhookDeliveriesByDeliveryIDRetry",
    tag: "Webhooks",
    method: "POST",
  ...
  {
    id: "getV1WebhooksDeliveriesById",
    tag: "Webhooks",
    method: "GET",
  ...
  {
    id: "postV1WebhooksDeliveriesByIdRetry",
    tag: "Webhooks",
    method: "POST",
  ...
  {
    id: "postV1WebhooksSubscriptions",
    tag: "Webhooks",
    method: "POST",
    path: "/v1/webhooks/subscriptions",
  ...
  {
    id: "deleteV1WebhooksSubscriptionsById",
    tag: "Webhooks",
    method: "DELETE",
  ...
  {
    id: "getV1WorkflowPoliciesByProjectID",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "putV1WorkflowPoliciesByProjectID",
    tag: "Workflows",
    method: "PUT",
    path: "/v1/workflow-policies/{projectID}",
    summary: "Upsert workflow policy",
  },
  {
    id: "getV1WorkflowRuns",
    tag: "WorkflowRuns",
    method: "GET",
  ...
  {
    id: "deleteV1WorkflowRunsByWorkflowRunID",
    tag: "WorkflowRuns",
    method: "DELETE",
  ...
  {
    id: "getV1WorkflowRunsByWorkflowRunID",
    tag: "WorkflowRuns",
    method: "GET",
    path: "/v1/workflow-runs/{workflowRunID}",
  ...
  {
    id: "getV1WorkflowRunsByWorkflowRunIDExplain",
    tag: "Workflows",
    method: "GET",
    path: "/v1/workflow-runs/{workflowRunID}/explain",
    summary: "List workflow step decisions",
  },
  {
    id: "getV1WorkflowRunsByWorkflowRunIDGraph",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "getV1WorkflowRunsByWorkflowRunIDLabels",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "postV1WorkflowRunsByWorkflowRunIDPause",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "postV1WorkflowRunsByWorkflowRunIDResume",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "postV1WorkflowRunsByWorkflowRunIDRetry",
    tag: "WorkflowRuns",
    method: "POST",
    path: "/v1/workflow-runs/{workflowRunID}/retry",
    summary: "Retry from first failed step",
  },
  {
    id: "getV1WorkflowRunsByWorkflowRunIDSteps",
    tag: "WorkflowRuns",
    method: "GET",
  ...
  {
    id: "postV1WorkflowRunsByWorkflowRunIDStepsByStepRefApprove",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "postV1WorkflowRunsByWorkflowRunIDStepsByStepRefForceComplete",
    tag: "WorkflowRuns",
    method: "POST",
    path: "/v1/workflow-runs/{workflowRunID}/steps/{stepRef}/force-complete",
    summary: "Force-complete a step",
  },
  {
    id: "postV1WorkflowRunsByWorkflowRunIDStepsByStepRefReplaySubtree",
    tag: "WorkflowRuns",
    method: "POST",
    path: "/v1/workflow-runs/{workflowRunID}/steps/{stepRef}/replay-subtree",
    summary: "Replay a step subtree",
  },
  {
    id: "postV1WorkflowRunsByWorkflowRunIDStepsByStepRefRetry",
    tag: "WorkflowRuns",
    method: "POST",
    path: "/v1/workflow-runs/{workflowRunID}/steps/{stepRef}/retry",
    summary: "Retry a single workflow step",
  },
  {
    id: "postV1WorkflowRunsByWorkflowRunIDStepsByStepRefSkip",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "postV1WorkflowRunsBulkCancel",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "postV1WorkflowRunsBulkReplay",
    tag: "WorkflowRuns",
    method: "POST",
  ...
  {
    id: "deleteV1WorkflowsByWorkflowID",
    tag: "Workflows",
    method: "DELETE",
  ...
  {
    id: "patchV1WorkflowsByWorkflowID",
    tag: "Workflows",
    method: "PATCH",
    path: "/v1/workflows/{workflowID}",
  ...
  {
    id: "postV1WorkflowsByWorkflowIDClone",
    tag: "Workflows",
    method: "POST",
  ...
  {
    id: "postV1WorkflowsByWorkflowIDDryRun",
    tag: "Workflows",
    method: "POST",
  ...
  {
    id: "getV1WorkflowsByWorkflowIDGraph",
    tag: "Workflows",
    method: "GET",
    path: "/v1/workflows/{workflowID}/graph",
    summary: "Get DAG visualization",
  },
  {
    id: "postV1WorkflowsByWorkflowIDPlan",
    tag: "Workflows",
    method: "POST",
    path: "/v1/workflows/{workflowID}/plan",
    summary: "Build topological workflow plan preview",
  },
  {
    id: "getV1WorkflowsByWorkflowIDRuns",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "postV1WorkflowsByWorkflowIDSimulate",
    tag: "Workflows",
    method: "POST",
  ...
  {
    id: "postV1WorkflowsByWorkflowIDTrigger",
    tag: "Workflows",
    method: "POST",
  ...
  {
    id: "getV1WorkflowsByWorkflowIDVersions",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "getV1WorkflowsByWorkflowIDVersionsByFromVersionIDDiffByToVersionID",
    tag: "Workflows",
    method: "GET",
  ...
  {
    id: "getV1WorkflowsByWorkflowIDVersionsByVersionID",
    tag: "Workflows",
    method: "GET",
    path: "/v1/workflows/{workflowID}/versions/{versionID}",
    summary: "Get workflow version by version ID",
  },
  {
    id: "getV1WorkflowsByWorkflowIDVersionsByVersionIDImpact",
    tag: "Workflows",
    method: "GET",
    path: "/v1/workflows/{workflowID}/versions/{versionID}/impact",
    summary: "Workflow version impact",
  },
  {
    id: "getV1WorkflowsByWorkflowIDVersionsByVersionIDSteps",
    tag: "Workflows",
    method: "GET",
...
export const generatedOperationsByTag = generatedOperations.reduce<
  Record<string, ReadonlyArray<GeneratedOperation>>
>((acc, operation) => {
