...
|---|---|---|---|
| `strait` | `ghcr.io/strait-dev/strait:0.1.5` | 8080 | API server + worker | <!-- x-release-please-version -->
| `strait-app` | `ghcr.io/strait-dev/strait-app:0.1.5` | 3000 | Dashboard UI | <!-- x-release-please-version -->
